...
\subsection*{Version 4.12.2, October 2019}
\begin{itemize}
\item Fixed another bug that prevented Nemp from starting on some systems.
\end{itemize}
...
\begin{itemize}
\item Fixed a bug that prevented Nemp from starting on some systems.
\end{itemize}
