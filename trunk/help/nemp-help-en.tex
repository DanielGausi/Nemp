...
The following is a summary of the new features in the individual versions - from the current version to the very first version of this program, which at that time was not even a player.
