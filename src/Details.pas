    ...
    begin
        ...
        try
            ...
            begin
                ...
                if not PicStreamToBitmap(picStream, 'image/jpeg', ID3Image.Picture.Bitmap) then
                    if not PicStreamToBitmap(picStream, 'image/png', ID3Image.Picture.Bitmap) then
                        if not PicStreamToBitmap(picStream, 'image/bmp', ID3Image.Picture.Bitmap) then
        ...
        at_Mp3: begin
                    ...
                    try
                        ...
                        begin
                            ...
                            PicStreamToBitmap(stream, Mime, ID3IMAGE.Picture.Bitmap);
        ...
        at_Flac: begin
                      ...
                      begin
                          ...
                          try
                              ...
                              PicStreamToBitmap(stream, TFlacPictureBlock(PictureFrames[0]).Mime, ID3IMAGE.Picture.Bitmap);
...
begin
    ...
    try
        ...
        begin
            ...
            PicStreamToBitmap(stream, TFlacPictureBlock(PictureFrames[idx]).Mime, ID3IMAGE.Picture.Bitmap);
